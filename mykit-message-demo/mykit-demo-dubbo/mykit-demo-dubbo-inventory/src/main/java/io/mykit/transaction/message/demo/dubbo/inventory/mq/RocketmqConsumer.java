...
public class RocketmqConsumer {
    ...
    @Autowired
    public RocketmqConsumer(Environment env, MykitMqReceiveService mykitMqReceiveService, MykitTransactionMessageConfig mykitTransactionMessageConfig) {
        this.env = env;
    ...
    public DefaultMQPushConsumer pushConsumer() throws MQClientException {
        ...
        consumer.registerMessageListener((List<MessageExt> msgList,
            ...
            try {
                ...
                final Boolean aBoolean = mykitMqReceiveService.processMessage(message);
