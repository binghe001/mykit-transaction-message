 ...
 * @author binghe
 * @version 1.0.0
 * @description MykitTransactionHandler
 */
@FunctionalInterface
public interface MykitTransactionHandler {
     ...
     * @throws Throwable ex
     */
    Object handler(ProceedingJoinPoint point, MykitTransactionMessageContext mykitTransactionMessageContext) throws Throwable;
}
